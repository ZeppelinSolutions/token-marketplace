...
class NewTokenPurchase extends React.Component {
        ...
        <div className="col s12">
          <form className="card" onSubmit={this._handleSubmit}>
            <div className="card-content">
              ...
              <p>Please select the token you want to buy, or enter a token address manually below</p>
  ...
  _handleSubmit(e) {
    ...
    Store.dispatch(TokenPurchaseActions.create(state.token, state.owner, state.amount, state.price))
  }
...
export default withRouter(NewTokenPurchase)
